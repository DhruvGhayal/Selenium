...
public class Class13JavaScriptExec {
	public static void main(String[] args) {
		...
		Class13JavaScriptUtility.drawBorder(element, driver);
		System.out.println(Class13JavaScriptUtility.getTitleByJavaScript(driver));
